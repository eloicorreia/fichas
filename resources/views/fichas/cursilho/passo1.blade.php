  ...
  <div class="wrap">
    <main class="card" role="main" aria-label="Ficha de inscrição">
      ...
      <section class="content">
        ...
        <div class="badge">
          <span>Passo 1 de 6 • {{ $numero }}º Cursilho para {{ strtoupper($sexoLabel) }}</span>
        </div>

        <!-- IMAGEM DO EVENTO -->
        <div class="event-image">
          <img src="{{ asset('assets/img/' . $numero . '.jpg') }}" alt="Imagem do evento {{ $numero }}">
        </div>
        ...
        <div class="event-box">
          <p class="event-line"><strong>EVENTO:</strong> {{ $numero }}º Cursilho para {{ strtoupper($sexoLabel) }}</p>
